<template>
  <div class="my">
    ...
    <div class="main">
      ...
      <van-cell title="私教记录" is-link to="/home/information" size="large" icon="user-o"/>
      <van-cell title="场地记录" is-link to="/home/erwe" size="large" icon="location-o"/>
      <van-cell title="健身房管理" is-link to="/home/suggest" size="large" icon="vip-card-o"/>
